 ...
 * @param objectList Vector of NvDsInferParseObjectInfo objects to which bounding box information must
 * be stored.
 * 
 * @return true
 */
 ...
 * @param bboxInfo Vector of bounding boxes.
 */
 ...
 * 
 * @param inputBBoxInfo Vector of bounding boxes belonging to a single class.
 * @param nmsThresh Overlap threshold for NMS.
 * 
 * @return Vector of bounding boxes of a single class after NMS is applied.
 */
 ...
 * @param nmsThresh Overlap threshold for NMS.
 * 
 * @return Vector of bounding boxes of all classes after NMS is applied.
 */
...
nmsAllClasses(std::vector<NvDsInferParseObjectInfo>& bboxInfo, const uint numClasses, const float nmsThresh)
{
    ...
    // Vector of Vector (of size numClasses) to hold classwise bounding boxes.
 ...
 * 
 * @return Vector of bounding boxes of all classes obtained by decoding the TinyYOLOv2 output.
 */
